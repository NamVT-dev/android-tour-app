...
import vn.edu.fpt.prm.features.user.UserApi;
...
public class EditProfileActivity extends AppCompatActivity {
    ...
    private void updateProfile() {
        ...
        userService.updateProfile("Bearer " + token, request).enqueue(new Callback<Void>() {
            @Override
    ...
    private void updatePassword() {
        ...
        // UserApi api = ApiClient.createService(UserApi.class);
        userService.changePassword("Bearer " + token, request).enqueue(new Callback<TokenResponse>() {
            @Override
    ...
    private void uploadPhoto(Uri uri) {
        ...
        // UserApi api = ApiClient.createService(UserApi.class);
        userService.updatePhoto("Bearer " + token, body).enqueue(new Callback<Void>() {
            @Override
            public void onResponse(Call<Void> call, Response<Void> response) {
                if (response.isSuccessful()) {
